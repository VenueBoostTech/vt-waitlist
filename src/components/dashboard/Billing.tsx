...
const faqs = [
  ...
  },
  {
    ...
    answer: "When you upgrade, you'll be charged prorated amount for the remainder of your billing cycle. Your new features will be available immediately."
  },
  {
    ...
    <div className="bg-white rounded-lg shadow-sm border">
      <div className="relative flex items-center justify-between p-4 border-b">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-0.5">Choose the perfect plan for your needs. All plans include 14-day free trial.</p>
        </div>
        <div className="flex space-x-3">
          ...
          >
            Annual
            <span className="ml-1.5 text-xs py-0.5 px-1.5 bg-green-100 text-green-700 rounded">-20%</span>
          </button>
        </div>
      </div>
        ...
        <div className="p-4 bg-[#f8f5f4] flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm font-medium text-[#a47764]">
              {currentSubscription.product.name.replace('Waitlist OmniStack - ', '')}
            </span>
    ...
    <div>
      ...
      <div className="flex items-center justify-between mt-4 text-sm">
        <div className="text-gray-600">
          Showing {startIndex + 1} to {Math.min(endIndex, transactionHistory.length)} of {transactionHistory.length} entries
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="p-8 flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-6">
              Our team is ready to assist you in finding the perfect plan for your needs. 
          ...
          <div className="bg-gray-50 p-8 flex flex-col justify-center items-center">
            <div className="text-center">
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Enterprise Support</h4>
              <p className="text-gray-600">
                Looking for custom solutions? Our enterprise team is here to help with tailored plans and dedicated support.
              </p>
            </div>
          </div>
        </div>
