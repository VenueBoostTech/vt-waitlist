    ...
    <div className="space-y-4 p-4 border border-gray-200 rounded-md">
      ...
      <label className="flex items-center">
        <input
          ...
          style={{ backgroundColor: getBackgroundColor() }}
        />
        <span className="ml-2 text-sm" style={{ color: getTextColor() }}>
          Required
        </span>
      </label>
    </div>
...
export function FormSection() {
  const { content, style, activeSection, setActiveSection, updateSection } =
    useBuilder();
  const formContent = (content.form as FormContent) || defaultFormContent;
  ...
  if (!isActive) {
    return (
      ...
      >
        ...
        <p className="mt-2" style={{ color: getTextColor(), opacity: 0.8 }}>
        ...
        <div className="mt-6 space-y-4">
          ...
          >
            {formContent.submitButton?.text || "Submit"}
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div
      className={`p-6 bg-white ${getBorderRadiusClass()} shadow-lg ring-2 ring-blue-500`}
      style={{ backgroundColor: getBackgroundColor() }}
    >
      <input
        type="text"
        ...
        style={{ color: getTextColor(), backgroundColor: getBackgroundColor() }}
      ...
      <div className="mt-6 space-y-6">
        ...
        <div className="p-4 border border-gray-200 rounded-md">
          <h3 className="font-medium mb-2" style={{ color: getTextColor() }}>
            Submit Button
          </h3>
          <input
            type="text"
            value={formContent.submitButton?.text || "Submit"}
            onChange={(e) =>
              updateSection("form", {
                submitButton: {
